...
export const FinalCTA: React.FC = () => {
  ...
  <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center items-center w-full">
          <button className="nv-glow-btn px-8 py-4 rounded-xl text-lg w-full sm:w-auto">
            {t.primaryCTA}
          </button>
          <button className="border rounded-xl px-8 py-4 text-lg border-white/20 text-white hover:bg-white/10 w-full sm:w-auto">
            {t.secondaryCTA}
          </button>
        </div>
      </div>
